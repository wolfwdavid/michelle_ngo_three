...
- **Next:** Phase 6 (PBS / Press / About / Contact) — content surfaces restyled cinematically but content-identical to `_four`; verbatim PBS blockquote, prestige-ordered press credits, ambient-bg `/about`, shared `<ContactBlock />` everywhere.
